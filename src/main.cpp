...
uint256 hashGenesisBlock("0x398b9b545c2df2086cd496632bf46c74a21cc3354110d278991989a903187953");
...
const string strMessageMagic = "SnorCoin Signed Message:\n";
...
{
    int64 nSubsidy = 13173137 * COIN;

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // SnorCoin: 0.35 days
static const int64 nTargetSpacing = 15; // SnorCoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal SnorCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SnorCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2c714337e1a57e9fa992cefc213bd2005d7643712e2137208e25f4a29c399a86");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Op een dag was er eens een snor genaamd Snorro. Hij was zo cool dat iedereen stierf. Einde.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1415161718;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 387932677;

        if (fTestNet)
        {
            block.nTime    = 1366559428;
            block.nNonce   = 387631791;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x178b4530fae15beccb1c466ad9707b2f7ad4ab9f08035009a20983301c716202"));
