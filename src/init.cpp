...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to SnorCoin server / RPC client
            std::string strUsage = _("SnorCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  SnorCoin [options]                     " + "\n" +
                  "  SnorCoin [options] <command> [params]  " + _("Send command to -server or SnorCoin") + "\n" +
                  "  SnorCoin [options] help                " + _("List commands") + "\n" +
                  "  SnorCoin [options] help <command>      " + _("Get help for a command") + "\n";
...
{
    uiInterface.ThreadSafeMessageBox(str, _("SnorCoin"), CClientUIInterface::OK | CClientUIInterface::MODAL);
    return false;
}

bool static InitWarning(const std::string &str)
{
    uiInterface.ThreadSafeMessageBox(str, _("SnorCoin"), CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
    return true;
}
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: SnorCoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: SnorCoin.pid)") + "\n" +
...
//    }
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s.  SnorCoin is probably already running."), GetDataDir().string().c_str()));
    ...
    // requested to kill SnorCoin-qt during the last operation. If so, exit.
